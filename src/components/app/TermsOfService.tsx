    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="border-0 shadow-lg">
        <CardHeader className="text-center pb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Effective Date: August 28, 2026<br />
      ...
      <Card>
        <CardContent className="pt-6">
          <p className="text-muted-foreground leading-relaxed">
            Welcome to TW Ventures LLC ("Company", "we", "our", "us"). These Terms of Service ("Terms") govern your access to and use of this application, its tools, calculators, content, dashboards, and related services (collectively, the "Services").
          </p>
          <p className="text-muted-foreground leading-relaxed mt-4">
            By using TW Ventures, you agree to these Terms. If you do not agree, please do not use the Services.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            You must be at least 18 years old and legally capable of entering into a binding agreement to use TW Ventures. If you're using the Services on behalf of an entity, you represent that you have the authority to bind that entity.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            TW Ventures provides tools and features for:
          </p>
          <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
            <li>Real estate underwriting, including BRRRR and rental analysis</li>
            <li>Saved-deal comparison and amortization modeling</li>
            <li>Property sourcing and mapping where data providers are configured</li>
            <li>Interest-rate and operational dashboards</li>
          </ul>
          <p className="text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            You may submit content such as deal information, account details, or feedback. By doing so, you grant TW Ventures a limited, non-exclusive license to process that content only as needed to provide and improve the Services.
          </p>
          <p className="text-muted-foreground">
            You must not post:
          </p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            TW Ventures provides informational and educational tools only. We are not a licensed financial advisor, tax consultant, or investment broker.
          </p>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            All TW Ventures content, designs, software, tools, and branding are protected by intellectual property laws. You may not copy, distribute, modify, or create derivative works without express written consent.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            We reserve the right to suspend or terminate your access to TW Ventures for any reason, including violation of these Terms, without notice or liability.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            To the maximum extent permitted by law, TW Ventures shall not be liable for indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of data, business interruption, or financial losses arising out of your use of the Services.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            TW Ventures User Conduct Guidelines
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>Do not use TW Ventures for money laundering, fraud, or illegal activity</li>
            ...
            <div>
              <h4 className="font-semibold mb-2">4. Respect Project Data</h4>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>Deal and project information must be accurate to the best of your knowledge</li>
                <li>You are responsible for verifying source data before relying on an analysis</li>
                <li>Do not submit confidential third-party information without authorization</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>Do not scrape, sell, or reproduce TW Ventures data without permission</li>
      ...
      <Card>
        <CardHeader>
          <CardTitle>TW Ventures Refund Policy</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <h4 className="font-semibold mb-2">1. Digital Products and Subscriptions</h4>
            <p className="text-muted-foreground mb-4">
              Due to the digital and personalized nature of our services (e.g., underwriting reports, calculators, dashboards, and operational insights), all purchases are generally non-refundable once delivered or accessed.
            </p>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Refund requests related to billing errors, fraud, or customer dissatisfaction are handled on a case-by-case basis. Contact your workspace administrator within 7 days of the charge.
            </p>
          </div>

          <div>
            <h4 className="font-semibold mb-2">4. Third-Party Payments</h4>
            <p className="text-muted-foreground">
              Payments associated with third-party projects or counterparties are governed by the applicable agreement. TW Ventures does not mediate third-party payment disputes through this application.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-2 text-muted-foreground">
            <p><strong>Contact:</strong> Your TW Ventures workspace administrator</p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="text-center text-sm text-muted-foreground">
        <p>These terms are designed to protect both users and TW Ventures while supporting a professional, secure real estate operations workspace.</p>
      </div>
    </div>
  );
};
