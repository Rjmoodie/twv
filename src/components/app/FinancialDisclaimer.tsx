...
const DISCLAIMERS = {
  general: `The information provided on TW Ventures is for informational and educational
purposes only and does not constitute investment advice, financial advice, trading advice,
or any other type of advice. TW Ventures is not a registered investment advisor, broker-dealer,
...
and are provided for informational purposes only. TW Ventures does not independently verify
