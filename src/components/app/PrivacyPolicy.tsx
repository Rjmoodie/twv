  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardContent className="pt-6">
          <p className="text-muted-foreground leading-relaxed">
            At TW Ventures LLC ("we," "us," or "our"), we are committed to protecting your privacy. This Privacy Policy describes how we collect, use, disclose, and safeguard your personal information when you use this application and related services (collectively, the "Services").
          </p>
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              ...
              <li>Fill out underwriting, project, or account forms</li>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li>Other authorized workspace users when you choose to share project information</li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            We retain your personal data as long as your account is active or as needed to provide Services. You can request account deletion from Account → Data &amp; Billing or through your workspace administrator.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground mt-4">
            Submit requests through your TW Ventures workspace administrator.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            TW Ventures is not intended for users under the age of 18. We do not knowingly collect data from children.
          </p>
        </CardContent>
      </Card>
