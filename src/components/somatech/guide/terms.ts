/**
 * Single source of truth for every financial term definition in SomaTech.
...
export const TERMS: Record<string, TermDef> = {
  ...
  plaid_read_only: {
    ...
    explain: 'SomaTech can see your balances and transactions to generate insights. It cannot move, transfer, or touch your money.',
  },
  financial_picture: {
