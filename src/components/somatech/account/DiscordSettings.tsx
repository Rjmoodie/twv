...
import { ExternalLink, CheckCircle2, Link, Unlink, RefreshCw, AlertTriangle } from 'lucide-react';
    ...
    <Card className="app-card">
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-[10px] text-muted-foreground text-center">
          SomaTech only reads your Discord username and ID — it cannot post or read messages on your behalf.{' '}
          <a
            href="https://discord.gg/somatech"
            target="_blank"
            rel="noopener noreferrer"
            className="underline inline-flex items-center gap-0.5"
          >
            Join server <ExternalLink className="h-2.5 w-2.5" />
          </a>
        </p>
      </CardContent>
    </Card>
