  ...
  const items = [
    {
      ...
      body:  'SomaTech cannot move money, initiate transfers, or make payments on your behalf.',
    },
    {
      title: 'Credentials stay with Plaid',
      body:  'Your bank login is never stored by SomaTech — only a secure, revocable token from Plaid.',
    },
    {
