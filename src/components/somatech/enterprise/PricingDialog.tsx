...
const FEATURE_ROWS: { label: string; tiers: SubscriptionTier[] }[] = [
  { label: "Dashboard & Watchlist",                tiers: ["free", "tier1", "tier2", "tier3"] },
  { label: "Earnings Calendar",                    tiers: ["free", "tier1", "tier2", "tier3"] },
  { label: "Financial Coach (AI)",                 tiers: ["free", "tier1", "tier2", "tier3"] },
  { label: "Stock Analysis & DCF",                 tiers: ["tier1", "tier2", "tier3"] },
  { label: "PDUFA Calendar",                       tiers: ["tier1", "tier2", "tier3"] },
  { label: "Portfolio Management",                 tiers: ["tier1", "tier2", "tier3"] },
  { label: "Retirement & Cash Flow Tools",         tiers: ["tier1", "tier2", "tier3"] },
  { label: "Options Dashboard",                    tiers: ["tier2", "tier3"] },
  { label: "Business Valuation",                   tiers: ["tier2", "tier3"] },
  { label: "Lead Gen & Real Estate",               tiers: ["tier2", "tier3"] },
  { label: "Courses & Academy",                    tiers: ["tier3"] },
  { label: "AI Trade Suggestions",                 tiers: ["tier3"] },
];
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            Upgrade once — all tools unlock immediately with no hidden fees.
          </DialogDescription>
        </DialogHeader>
