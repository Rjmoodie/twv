...
export const SUBSCRIPTION_PLANS: Record<SubscriptionTier, SubscriptionPlan> = {
  free: {
    ...
    interval: 'month',
    features: [
      'Dashboard & financial journey',
      'Watchlist (sync across devices)',
      'Retirement & cash flow calculators',
      'Personal finance with Plaid (2 accounts)',
  ...
  tier1: {
    ...
    features: [
      'Everything in Free',
      'AI Financial Coach',
      'Real Estate calculator & deal sourcing',
      'Business Valuation & DCF tools',
