...
export default function InvestorInquiryPage() {
  ...
  return (
    <main className="public-page">
      <PublicBrandHeader section="Investor Partnerships" actions={<Button aria-label={user ? 'Open portal' : 'Project access'} variant="ghost" className="gap-2 text-[#071a33]" onClick={enterPortal}><LogIn className="h-4 w-4" /><span className="brand-nav-label">{user ? 'Open portal' : 'Project access'}</span></Button>} />
