...
export default function ProjectIntakePage() {
  ...
  return <main className="public-page">
    <PublicBrandHeader section="Investor Project Consultation" actions={<Button aria-label="Back to site" variant="ghost" className="text-[#071a33]" onClick={() => navigate('/')}><ArrowLeft className="mr-2 h-4 w-4" /><span className="brand-nav-label">Back to site</span></Button>} />
