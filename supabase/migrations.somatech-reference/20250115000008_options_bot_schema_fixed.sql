-- Options Trading Bot Schema for SomaTech (Fixed Version)
...
-- Allow authenticated users and anonymous users to read plays (for dashboard)
CREATE POLICY "Users can read plays" ON public.plays
